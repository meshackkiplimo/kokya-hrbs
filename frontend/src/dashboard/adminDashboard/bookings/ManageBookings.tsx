...
const ManageBookings = () => {
    ...
    const BookingCard = ({ booking }: { booking: any }) => (
        <div className="bg-white border border-gray-200 rounded-lg shadow-sm p-4 mb-4">
            <div className="flex justify-between items-start mb-3">
                <div>
                    <h3 className="font-semibold text-lg text-gray-900">Booking #{booking.booking_id}</h3>
            ...
            <div className="space-y-2">
                <div className="flex flex-col sm:flex-row sm:justify-between">
                    ...
                    <span className="text-sm font-medium">{booking.hotel_id}</span>
                </div>
                <div className="flex flex-col sm:flex-row sm:justify-between">
                    <span className="text-sm text-gray-600">Room ID:</span>
                    <span className="text-sm font-medium">{booking.room_id}</span>
                </div>
                <div className="flex flex-col sm:flex-row sm:justify-between">
  ...
  return (
    <div className='p-3 md:p-6'>
        <h2 className='text-xl md:text-2xl font-bold mb-4 md:mb-6'>Manage Bookings</h2>
                            ...
                            <tbody>
                                {bookingsData.map((booking) => (
                                    <tr key={booking.booking_id} className="hover:bg-gray-300 border-b border-gray-400">
                                        ...
                                        <td className="px-4 py-2 border-r border-gray-400">{booking.hotel_id}</td>
                                        ...
                                        <td className="px-4 py-2 border-r border-gray-400">
                                            <DeleteBooking bookingId={booking.booking_id} />
                                            </td>
                                    </tr>
                                ))}
                            </tbody>
